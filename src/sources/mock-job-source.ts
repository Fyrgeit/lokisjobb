    ...
    return [
      {
        ...
        description: "Kör regional trafik och bidra till trygga resor varje dag."
      },
      {
        ...
        description: "Planera trafikflöden och samordna den dagliga driften."
      },
      {
        ...
        description: "Arbeta med förebyggande underhåll av modern infrastruktur."
      }
    ];
  }
}
